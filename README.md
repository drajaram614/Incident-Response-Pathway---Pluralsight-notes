...
## Detection and Analysis (Initial Triage Notes)
Notes covering initial triage, alert validation, and early-stage investigation.

## Host Analysis Notes
Notes related to endpoint investigation, artifacts, and host-based forensics.

## Network Analysis Notes
Notes focused on traffic analysis, packet inspection, and network-based indicators.

## Eradication Phase Notes
Notes on remediation strategies, containment, and removal of threats.

## Windows Event Logs Forensics / Windows Analysis / Windows Registry Forensics Notes
Notes covering Windows event logs, system analysis, and registry forensics.
